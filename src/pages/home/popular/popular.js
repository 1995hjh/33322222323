                ...
                <View className='popularView'>
                    ...
                    <View className='listView'>
                        <View className='itemView'>
                            ...
                            <Tag title='好货内部价'/>
                            <Text className='itemPriceTxt'>Free Cross男式四面弹力牛仔裤 </Text>
                            <Text className='limitOriginPrice'>¥194.00</Text>
                        </View>
                        <View className='itemView'>
                            <Image src='https://yanxuan.nosdn.127.net/04a607d7b2f3d0f8a3beea7c0ffa3a72.png' className='itemIcon' />
                            <Tag title='好货内部价' />
                            <Text className='itemPriceTxt'>黑芝麻 </Text>
                            <Text className='limitOriginPrice'>¥69.00</Text>
                        </View>
                        <View className='itemView'>
                            <Image src='https://yanxuan.nosdn.127.net/9cf70438be99e0662c8123032228f870.png' className='itemIcon' />
                            <Tag title='限时购' />
                            <Text className='itemPriceTxt'>泰国制造 天然乳胶枕 护颈按摩 </Text>
                            <Text className='limitOriginPrice'>¥169.00</Text>
                        </View>
                    </View>
                </View>
            </View>
