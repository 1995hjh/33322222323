            ...
            <View className='limitView'>
                <HomeTitle title='限时购'>
                    <View className='timeView'>
                        <Text className='timeSize timeTxt'>23</Text>
                        <Text className='timeSize timeSplit'>:</Text>
                        <Text className='timeSize timeTxt'>21</Text>
                        <Text className='timeSize timeSplit'>:</Text>
                        <Text className='timeSize timeTxt'>12</Text>
                    </View> 
                </HomeTitle>
